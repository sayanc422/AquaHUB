...
**These runbooks have been written, not rehearsed.** Three of the four describe a failure that has
been reproduced locally; the Argo CD one describes behaviour of a component that is not installed
until Phase 4. Say so rather than implying a practised incident history.
